...
<body>
	...
	<div class="container">
		...
		<form action="/semi_team1/join.do?cmd=insert" method="post"
			class="navbar-form">
			<label>아이디</label><br> <input type="text" value="아이디" name="id"
				id="id" class="form-control"><input type="button"
				value="중복확인"><br> <label>닉네임</label><br> <input
				type="text" value="닉네임" name="m_nick" id="m_nick"
				class="form-control"><input type="button" value="중복확인"><br>
			<label>비밀번호</label><br> <input type="text" value="비밀번호"
				name="u_pw" id="u_pw" class="form-control"><br> <label>비밀번호
				확인</label><br> <input type="text" value="비밀번호 확인" name="checkpw"
				id="checkpw" class="form-control"><br> <label>이메일</label><br>
			<input type="text" value="이메일" name="m_mail" id="m_mail"
