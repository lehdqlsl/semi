...
<script type="text/javascript">
	...
	function limitCheck(){
		...
		xhr.open('get',"/semi_team1/board/limitpage.jsp?writer=${sessionScope.m_nick }",true);
		xhr.send();
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
		<div style="margin: auto; width: 1000px; word-break: break-all; word-wrap: break-word;">
			...
			<c:if test="${!empty sessionScope.m_nick}">
				<input class="btn btn-sm btn-success" type="button" value="글쓰기" onclick="limitCheck()">
