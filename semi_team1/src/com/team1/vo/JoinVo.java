...
public class JoinVo {
	...
	public JoinVo(int num, String id,String u_pw, String m_nick, String m_mail, String m_orgfilename, String m_savefilename,
	...
	public JoinVo(String id, String u_pw, String m_nick, String m_mail) {
		this.id = id;
		this.u_pw = u_pw;
		this.m_nick = m_nick;
		this.m_mail = m_mail;
