...
@WebServlet("/member/limit/list")
public class MembersLimitListController extends HttpServlet{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<JoinVo> list = dao.memberlimitlist(startRow, endRow);
		// 전체 페이지 개수 구하기
		int pageCount = (int) Math.ceil(dao.getLimitMemCount() / 20.0);
		// 시작 페이지 구하기
		...
		request.getRequestDispatcher("/index.jsp?page=/manager/managerIndex.jsp&s_page=/manager/memberlimitlist.jsp")
